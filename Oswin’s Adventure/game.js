/********* THINGS TO DO *********/
/*
  - a start screen with the title, a description of the game
  - Add creative features that motivate the player
  - include things such as controls (like in Pong), power ups, scoring, lives
		- make it so that the player can collect hearts
*/
